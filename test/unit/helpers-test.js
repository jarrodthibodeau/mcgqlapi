...
describe('Helpers', () => {
    describe('isTitleSafeToSave', () => {
        context('Passing in a date that does not meet the save to db threshold', () => {
    ...
    describe('stripTitle', () => {
        context('Stripping characters of a complicated title', () => {
            const strippedTitle = stripTitle('DRAGON QUEST XI S: ECHOES OF AN ELUSIVE AGE - DEFINITIVE EDITION');

            it('should return the properly stripped title for a metacritic url', () => {
                const expectedTitle = 'DRAGON QUEST XI S ECHOES OF AN ELUSIVE AGE - DEFINITIVE EDITION';
